...
package net.gravitydevelopment.updater.ghosts;
    ...
    private boolean versionCheck(String title) {
        if (type != UpdateType.NO_VERSION_CHECK) {
            ...
            if (oldTokens.length == 3 && !version.contains("beta") && !version.contains("SNAPSHOT")) {
                plugin.getLogger().warning("Could not get information about this Ghosts version; perhaps you are running a custom one?");
